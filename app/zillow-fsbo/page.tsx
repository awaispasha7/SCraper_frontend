...
function ZillowFSBOPageContent() {
  ...
  const handleDownload = (listing: ZillowFSBOListing) => {
    ...
    const csvData = [
      ['address', 'price', 'beds', 'baths', 'listing_link', 'property_type', 'year_build', 'hoa', 'days_on_zillow', 'page_view_count', 'favorite_count', 'phone_number', 'owner_name', 'mailing_address', 'emails', 'phones'].join(','),
      [
  ...
  const filterListings = (listings: ZillowFSBOListing[]): ZillowFSBOListing[] => {
    if (!searchQuery.trim()) {
      return listings
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 lg:gap-4 w-full md:w-auto">
              ...
              <ScraperRunButton
                scraperId="zillow_fsbo"
                scraperName="Zillow FSBO"
                endpoint="/api/trigger-zillow-fsbo"
                color="purple"
              />
